...
Spam detection is a natural language processing (NLP) task that identifies unwanted or unsolicited messages. This project uses machine learning techniques such as Naive Bayes, Logistic Regression, and TF-IDF vectorization to classify messages as spam or ham (not spam). It's commonly applied in email filtering, SMS screening, and content moderation.

[![View on GitHub](https://img.shields.io/badge/GitHub-View_on_GitHub-blue?logo=GitHub)](https://github.com/483ashriths/spam-detection)

<center><img src="assets/img/spam_detection.jpg"/></center>
